...
@section('title', 'Data Semua Petugas')
                                    ...
                                    <tbody>
                                        @foreach ($all_data as $data)
                                            <tr>
                                                ...
                                                <td class="text-center">{{ $data->gender ?? 'N/A' }}</td>
                                                @if (auth()->check() && auth()->user()->role == 'admin')
                                                    <td class="font-italic">
                                                        {{ $data->users->first()->username ?? 'N/A' }}
                                                    </td>
                                                @endif
                                                <td class="text-right">
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center" style="gap: .5rem">
                                                        <a href="{{ url("/officer-data/{$data->id}/show") }}"
                                                        ...
                                                        @if (auth()->check() && auth()->user()->role === 'admin')
                                                            ...
                                                            <form action="{{ url("/officer-data/{$data->id}") }}"
                                                            ...
                                                            <form action="{{ url("/officer-data/{$data->id}/reset") }}"
                                                                method="POST" id="reset-form-{{ $data->id }}"
                                                                class="d-inline">
                                                                @method('PUT')
                                                                @csrf
