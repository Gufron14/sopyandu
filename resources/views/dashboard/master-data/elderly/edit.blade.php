        ...
        <section class="section">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ url("/elderly-data/{$elderly->id}") }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="row g-4">
                                    <div class="col-12">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="nik" type="number"
                                            ...
                                            value="{{ old('nik', $elderly->nik) }}" placeholder="5271xxxxxxxxxxxx">
                                        @error('nik')
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="fullname" type="text"
                                            ...
                                            value="{{ old('fullname', $elderly->fullname) }}" placeholder="Asep Budi" pattern="^[a-zA-Z\s]+$"
                                            autofocus>
                                        @error('fullname')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="birth_place" type="text"
                                            ...
                                            name="birth_place" value="{{ old('birth_place', $elderly->birth_place) }}"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="date_of_birth" type="date"
                                            ...
                                            name="date_of_birth"
                                            value="{{ old('date_of_birth', $elderly->date_of_birth) }}">
                                        @error('date_of_birth')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="gender" id="gender"
                                            ...
                                            <option value="L"
                                                {{ old('gender', $elderly->gender) == 'L' ? 'selected' : '' }}>Laki -
                                                Laki
                                            </option>
                                            <option value="P"
                                                {{ old('gender', $elderly->gender) == 'P' ? 'selected' : '' }}>
                                                Perempuan
                                            </option>
                                        </select>
                                        @error('gender')
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="blood_type" id="blood_type"
                                            ...
                                            <option value="-"
                                                {{ old('blood_type', $elderly->blood_type) == '-' ? 'selected' : '' }}>
                                                Belum Cek Golongan Darah
                                            </option>
                                            <option value="A"
                                                {{ old('blood_type', $elderly->blood_type) == 'A' ? 'selected' : '' }}>
                                                A
                                            </option>
                                            <option value="B"
                                                {{ old('blood_type', $elderly->blood_type) == 'B' ? 'selected' : '' }}>
                                                B
                                            </option>
                                            <option value="AB"
                                                {{ old('blood_type', $elderly->blood_type) == 'AB' ? 'selected' : '' }}>
                                                AB
                                            </option>
                                            <option value="O"
                                                {{ old('blood_type', $elderly->blood_type) == 'O' ? 'selected' : '' }}>
                                                O
                                            </option>
                                        </select>
                                        @error('blood_type')
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="province" id="province"
                                            ...
                                            data-old="{{ old('province', $elderly->province ?? '') }}">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="city" id="city"
                                            ...
                                            data-old="{{ old('city', $elderly->city ?? '') }}">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="subdistrict" id="subdistrict"
                                            ...
                                            data-old="{{ old('subdistrict', $elderly->subdistrict ?? '') }}">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="village" id="village"
                                            ...
                                            data-old="{{ old('village', $elderly->village ?? '') }}">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="hamlet" type="text"
                                            ...
                                            data-old="{{ old('hamlet', $elderly->hamlet ?? '') }}" value=""
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea name="address" id="address" class="form-control @error('address') is-invalid @enderror" rows="5"
                                            placeholder="Jl. Merdeka, No. 123, Jakarta" data-old="{{ old('address', $elderly->address ?? '') }}"></textarea>
                                        @error('address')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
