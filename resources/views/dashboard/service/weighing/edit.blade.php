...
@section('main')
    <div class="main-content">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" id="nutrition_status_display" class="form-control" readonly
                value="{{ old('nutrition_status', $weighing->nutrition_status) }}">
            ...
            @enderror
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ old('bb_u_zscore', $weighing->bb_u_zscore) }}" id="bb_u_zscore" readonly>
                                        <small class="form-text text-muted" id="bb_u_status"></small>
                                    </div>

                                    <div class="form-group col-md-3">
                                        <label>TB/U (Tinggi/Umur)</label>
                                        <input type="text" class="form-control" value="{{ old('tb_u_zscore', $weighing->tb_u_zscore) }}" id="tb_u_zscore" readonly>
                                        <small class="form-text text-muted" id="tb_u_status"></small>
                                    </div>

                                    <div class="form-group col-md-3">
                                        <label>BB/TB (Berat/Tinggi)</label>
                                        <input type="text" class="form-control" value="{{ old('bb_tb_zscore', $weighing->bb_tb_zscore) }}" id="bb_tb_zscore" readonly>
                                        <small class="form-text text-muted" id="bb_tb_status"></small>
                                    </div>

                                    <div class="form-group col-md-3">
                                        <label>IMT/U (BMI/Umur)</label>
                                        <input type="text" class="form-control" value="{{ old('imt_u_zscore', $weighing->imt_u_zscore) }}" id="imt_u_zscore" readonly>
    ...
    <script>
     ...
     <script>
        $(document).ready(function() {
            ...
            setTimeout(function() {
                $('#children_id').trigger('change');
                $('#weight, #height').trigger('input');
            }, 200);
