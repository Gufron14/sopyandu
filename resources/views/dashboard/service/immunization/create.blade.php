                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="mother_fullname" type="text" class="form-control"
                                            name="mother_fullname" value="" pattern="[A-Za-z ]+" placeholder="Imas" disabled>
                                    </div>
    ...
    function loadVaccinesByType(selectedType) {
        ...
        $.ajax({
            ...
            success: function(vaccines) {
                ...
                const oldVaccineId = '{{ old("vaccine_id") }}';
                if (oldVaccineId) {
                    $('#vaccine_id').val(oldVaccineId);
                    fillVaccineDetails();
                }
            },
            error: function() {
...
if (selectedStatus) {
    ...
    const selectedCategory = $('#vaccine_type').val();
    if (selectedCategory) {
        filterVaccinesByCategory(selectedCategory);
    }
